...
![Charts](screenshots/1.png)

Example Excel table:

![Excel Table](screenshots/2.png)
...
- **Path to the Excel file must include the file name itself** and use `/` or `\\` (Windows):
  - Example (Windows): `C:\\Users\\Rghjr\\Desktop\\steam_data.xlsx`
  - Example (Linux/macOS): `C:/Users/Rghjr/Desktop/steam_data.xlsx`
